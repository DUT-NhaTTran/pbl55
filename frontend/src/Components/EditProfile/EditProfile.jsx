...
const EditProfile = () => {
        ...
        if (send_uid) {
            axios
                ...
                .then((response) => {
                    ...
                    setAvatarPreviewUrl(userData.avatar ? `data:image/png;base64,${userData.avatar}` : defaultUserImage);
                })
                .catch((error) => {
    ...
    useEffect(() => {
        axios.get("http://127.0.0.1:8000/get_cids")
            .then((response) => {
    ...
    useEffect(() => {
        if (selectedCid) {
            axios.post("http://127.0.0.1:8000/get_classes/", { cid: selectedCid })
                .then((response) => {
    ...
    const handleSave = (e) => {
        ...
        axios.post("http://127.0.0.1:8000/edit_user_view", formData)
            .then((response) => {
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <input type="text" className="form-input" value={send_uid} readOnly />
                            </div>
                            <div className="form-group">
                                <label class="form-label">Name</label>
                                <input type="text" class="form-input" value={name} onChange={(e) => setName(e.target.value)} />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-input" value={id} onChange={(e) => setId(e.target.value)} />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Birth Date</label>
                                <input type="date" class="form-input" value={birthDate} onChange={(e) => setBirthDate(e.target.value)} />
                            </div>
                            <div class="form-group">
                                <label class="form-label">Gender</label>
                                <div class="gender-options">
                                    <label class="radio-label">
                                        <input type="radio" name="gender" value="male" checked={gender === 1} onChange={() => setGender(1)} />
                                        Male
                                    </label>
                                    <label class="radio-label">
                                        <input type="radio" name="gender" value="female" checked={gender === 0} onChange={() => setGender(0)} />
                                        Female
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-input" value={selectedCid} onChange={(e) => setSelectedCid(e.target.value)}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-input" value={selectedClass} onChange={(e) => setSelectedClass(e.target.value)} disabled={!classList.length}>
